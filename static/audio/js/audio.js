(function (window, document) {
	...
	var AudioPlay = function (setConfig) {

		var fn = this, selectId = setConfig.id, control = new Audio();
		//属性替换
		...
		//刷新进度
		this.schedule = function (status,startSchedule) {
			if(startSchedule) {
				control.currentTime = startSchedule;
		...
		this.volume = function (n) {
			...
			elem.volume.querySelector(selectId + ' .volume-box i').style.width = percentage(control.volume);
		}
